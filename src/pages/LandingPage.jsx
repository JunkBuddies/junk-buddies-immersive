...
function LandingPage() {
  ...
  return (
    <div className="w-full bg-black text-white overflow-x-hidden overflow-y-auto relative">
      ...
      {/* =========================
          STACK A: TOP (Hero + Rows)
          Isolated to prevent horizontal overflow affecting the rest
         ========================= */}
      <div
        id="stack-a"
...
<div
  className={`absolute 
    max-[639px]:left-[-0.1vw] max-[639px]:w-[13vw]
    sm:left-[-25vw] md:left-[-22vw] lg:left-[-20vw]
    sm:w-[30vw] md:w-[29vw] lg:w-[28vw]
...
<div
  className={`absolute 
    max-[639px]:right-[-0.1vw] max-[639px]:w-[13vw]
    sm:right-[-25vw] md:right-[-22vw] lg:right-[-20vw]
    sm:w-[30vw] md:w-[29vw] lg:w-[28vw]
    ${heroHeight} overflow-hidden border border-gold/30 shadow-2xl rounded-2xl`}
>
  <img
  ...
  />
    ...
    {!isMobile && (
      ...
      {/* =========================
          STACK B: EVERYTHING FROM "Require service today" DOWN
          Fully separated so it behaves independently
         ========================= */}
      <main
        id="stack-b"
        className="relative w-full max-w-[100vw] overflow-x-clip isolate"
        style={{ contain: "layout paint" }}
      >
