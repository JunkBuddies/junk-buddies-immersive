  ...
  >
    ...
    >
      ...
      <div
        className={`absolute ${
          isMobile
            ? "left-0 w-[22vw]" // ⬅ no negative offset, sits flush at screen edge
            : "left-[-30vw] sm:left-[-25vw] md:left-[-22vw] lg:left-[-20vw] w-[32.5vw] sm:w-[30vw]"
      ...
      <div
        className={`relative z-20 ${
          isMobile ? "w-[90vw]" : "w-[75vw] sm:w-[70vw]"
      ...
      <div
        className={`absolute ${
          isMobile
            ? "right-0 w-[22vw]" // ⬅ no negative offset, flush on the right
            : "right-[-30vw] sm:right-[-25vw] md:right-[-22vw] lg:right-[-20vw] w-[32.5vw] sm:w-[30vw]"
        } ${heroHeight} overflow-hidden border border-gold/30 shadow-2xl rounded-2xl`}
      >
        <img
