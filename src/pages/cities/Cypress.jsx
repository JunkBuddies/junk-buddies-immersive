...
{/* === SECTION 4: NEIGHBORHOODS / COVERAGE AREA (CYPRESS) === */}
<section className="relative w-full bg-gray-100 py-20 px-6 overflow-hidden">
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    >
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55535.61234044854!2d-95.7053!3d29.9691!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640cddf49ad0d07%3A0x5e75f1a1b5e4a1a!2sCypress%2C%20TX!5e0!3m2!1sen!2sus!4v1752291111111!5m2!1sen!2sus"
        width="100%"
        height="100%"
        style={{ border: 0 }}
        allowFullScreen=""
        ...
        title="Junk Buddies Cypress Coverage Map"
      ></iframe>
    </div>
    ...
    <div className="text-gray-800" data-aos="fade-up">
      ...
      <ul className="space-y-4 text-base sm:text-lg leading-relaxed">
        <li>
          <span className="text-gold font-semibold">Central Cypress →</span>{" "}
          77429, 77433
        </li>
        <li>
          <span className="text-gold font-semibold">North Cypress →</span>{" "}
          Bridgeland, Towne Lake, Coles Crossing
        </li>
        <li>
          <span className="text-gold font-semibold">South Cypress →</span>{" "}
          Cypress Creek Lakes, Copperfield
        </li>
        <li>
          <span className="text-gold font-semibold">East Cypress →</span>{" "}
          Jersey Village, FM 529 Corridor
        </li>
        <li>
          <span className="text-gold font-semibold">Suburbs & Beyond →</span>{" "}
          Houston, Katy, Tomball, Spring, The Woodlands, Magnolia, Waller
        </li>
      </ul>
    </div>
  </div>
...
<section className="relative w-full bg-white overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-16 px-6">
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="w-40 h-40 flex items-center justify-center rounded-full border-4 border-gold shadow-xl relative">
          <p className="text-center font-bold text-gold text-sm">
            Official<br />Junk Buddies<br />Cypress, TX
          </p>
        </div>
        {/* Trust Indicators */}
    ...
    <div className="text-gray-800" data-aos="fade-up">
      <h2 className="text-3xl sm:text-4xl font-bold text-gold mb-6">
        The Official Junk Buddies — Serving Cypress, Texas with Pride
      </h2>
      <p className="text-base sm:text-lg mb-4 leading-relaxed">
        ...
        by thousands of Cypress families and businesses.
      </p>
      <p className="text-base sm:text-lg mb-4 leading-relaxed">
      ...
      <p className="text-base sm:text-lg leading-relaxed font-semibold">
        When you choose Junk Buddies in Cypress, you’re choosing the original 
