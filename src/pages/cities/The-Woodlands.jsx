...
{/* === SECTION 4: NEIGHBORHOODS / COVERAGE AREA (THE WOODLANDS) === */}
<section className="relative w-full bg-gray-100 py-20 px-6 overflow-hidden">
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    >
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55316.01375935607!2d-95.5169!3d30.1658!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x864735f6f8b30a6d%3A0x3c4a0f2d2d444b1b!2sThe%20Woodlands%2C%20TX!5e0!3m2!1sen!2sus!4v1752298888888!5m2!1sen!2sus"
        width="100%"
        height="100%"
        style={{ border: 0 }}
        allowFullScreen=""
        ...
        title="Junk Buddies The Woodlands Coverage Map"
      ></iframe>
    </div>
    ...
    <div className="text-gray-800" data-aos="fade-up">
      ...
      <ul className="space-y-4 text-base sm:text-lg leading-relaxed">
        <li>
          <span className="text-gold font-semibold">Central The Woodlands →</span>{" "}
          Town Center, Hughes Landing, Market Street
        </li>
        <li>
          <span className="text-gold font-semibold">East The Woodlands →</span>{" "}
          Grogan’s Mill, Panther Creek
        </li>
        <li>
          <span className="text-gold font-semibold">West The Woodlands →</span>{" "}
          Sterling Ridge, Alden Bridge
        </li>
        <li>
          <span className="text-gold font-semibold">South The Woodlands →</span>{" "}
          Creekside Park, Indian Springs
        </li>
        <li>
          <span className="text-gold font-semibold">Suburbs & Beyond →</span>{" "}
          Spring, Conroe, Tomball, Magnolia, Shenandoah, Oak Ridge North, Houston
        </li>
      </ul>
    </div>
  </div>
...
<section className="relative w-full bg-white overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-16 px-6">
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="w-40 h-40 flex items-center justify-center rounded-full border-4 border-gold shadow-xl relative">
          <p className="text-center font-bold text-gold text-sm">
            Official<br />Junk Buddies<br />The Woodlands, TX
          </p>
        </div>
        {/* Trust Indicators */}
    ...
    <div className="text-gray-800" data-aos="fade-up">
      <h2 className="text-3xl sm:text-4xl font-bold text-gold mb-6">
        The Official Junk Buddies — Serving The Woodlands, Texas with Pride
      </h2>
      <p className="text-base sm:text-lg mb-4 leading-relaxed">
        ...
        by thousands of families and businesses in The Woodlands.
      </p>
      <p className="text-base sm:text-lg mb-4 leading-relaxed">
      ...
      <p className="text-base sm:text-lg leading-relaxed font-semibold">
        When you choose Junk Buddies in The Woodlands, you’re choosing the original 
