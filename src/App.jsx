...
function App() {
  return (
    <CartProvider>
      <Router>
        <Routes>
          {/* Everything inside LayoutShell = immersive app-like navigation */}
          <Route element={<LayoutShell />}>
            ...
            <Route
              path="/blog/how-much-does-junk-removal-cost"
              element={<HowMuchDoesJunkRemovalCost />}
            />
            <Route
              path="/blog/save-money-on-junk-removal"
              element={<SaveMoneyOnJunkRemoval />}
            />
            ...
            <Route
              path="/service-areas/missouri-city"
              element={<MissouriCity />}
            />
            <Route path="/service-areas/pasadena" element={<Pasadena />} />
            <Route
              path="/service-areas/the-woodlands"
              element={<TheWoodlands />}
            />
            <Route path="/service-areas/league-city" element={<LeagueCity />} />
            <Route path="/service-areas/baytown" element={<Baytown />} />
            <Route
              path="/service-areas/friendswood"
              element={<Friendswood />}
            />
            <Route
              path="/service-areas/channelview"
              element={<Channelview />}
            />
        ...
        {/* 🧠 Chat widget overlays all pages */}
        <ChatWidget />
      </Router>
    </CartProvider>
  );
